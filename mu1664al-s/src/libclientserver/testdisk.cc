...
{
    cout << article.id << endl << article.name << endl << article.author << endl << article.title << endl << article.text <<endl;
}
...
int main()
{
    ...
    Article article1{0,"article1", "vu", "title 1", "text 1"};
    Article article2{0,"article2", "vu", "title 1", "text 2"};
    Article article3{0,"article3", "vu", "title 1", "text 3"};
    Article article4{0,"article4", "vu", "title 1", "text 4"};
    Article article5{0,"article5", "vu", "title 1", "text 5"};
